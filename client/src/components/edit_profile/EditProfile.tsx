...
interface IProps extends RouteComponentProps {
  ...
  createProfile: (profileData: IClientProfile, history: History) => void;
...
interface IProfile extends IClientProfile {
  twitter?: string;
  facebook?: string;
  linkedin?: string;
  youtube?: string;
...
class EditProfile extends Component<IProps, IState> {
  ...
  componentWillReceiveProps(nextProps: IProps) {
    ...
    if (nextProps.profile && nextProps.profile.profile) {
      const profile: IProfile = nextProps.profile.profile;
