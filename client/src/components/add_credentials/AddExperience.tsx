...
interface IAddExperienceStateProps {
...
interface IAddExperienceProps
  extends IAddExperienceStateProps,
    RouteComponentProps {}

interface IAddExperienceState {
  company: string;
  title: string;
  location: string;
  from: string;
...
class AddExperience extends Component<
  ...
  IAddExperienceState
> {
  constructor(props: IAddExperienceProps) {
    super(props);
    this.state = {
      company: "",
      title: "",
  ...
  componentWillReceiveProps(nextProps: IAddExperienceProps) {
    if (nextProps.errors) {
